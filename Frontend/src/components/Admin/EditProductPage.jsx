      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className="w-full border-gray-600 outline-1 rounded-md p-2 "
            required
          />
        </div>
        {/* Description */}
        <div className="mb-6">
          ...
          <textarea
            ...
            onChange={handleChange}
            className="w-full border-gray-300 outline-1 rounded-md p-2 "
            rows={4}
            required
          />
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex gap-4 mt-4">
            {productData.images.map((image,index)=>(
              <div key={index}>
                <img src={image.url} alt={index} className="w-20 h-20 object-cover rounded-md shadow-md" />
              </div>
            ))}
          </div>
        </div>
